...
# installed.
TCL_PREFIX='F:/Generative-AI-Projects/genai_projects\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Generative-AI-Projects/genai_projects\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Generative-AI-Projects/genai_projects\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Generative-AI-Projects/genai_projects\Library\include'
...
TCL_PACKAGE_PATH='F:/Generative-AI-Projects/genai_projects\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Generative-AI-Projects/genai_projects\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Generative-AI-Projects/genai_projects\Library\lib\tclstub86.lib'
